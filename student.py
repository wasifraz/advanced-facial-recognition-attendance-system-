...
# first image
        ...
        dept_combo=ttk.Combobox(Current_Course_Frame,font=("times new roman",13,"bold"),width=20,state="readonly")
        ...
        group_combo=ttk.Combobox(Current_Course_Frame,font=("times new roman",13,"bold"),width=20,state="readonly")
        ...
        Sem_combo=ttk.Combobox(Current_Course_Frame,font=("times new roman",13,"bold"),width=20,state="readonly")
        ...
        StudentName_entry=ttk.Entry(Class_Info_Frame,font=('times new roman',12,"bold"),width=20)
        ...
        ClassDiv_combo=ttk.Combobox(Class_Info_Frame,font=("times new roman",13,"bold"),width=17,state="readonly")
        ...
        Gender_combo=ttk.Combobox(Class_Info_Frame,font=("times new roman",13,"bold"),width=17,state="readonly")
        ...
        DOB_entry=ttk.Entry(Class_Info_Frame,font=('times new roman',12,"bold"),width=20)
        ...
        Email_entry=ttk.Entry(Class_Info_Frame,font=('times new roman',12,"bold"),width=21)
        ...
        PhoneNo_entry=ttk.Entry(Class_Info_Frame,font=('times new roman',12,"bold"),width=20)
        ...
        Address_entry=ttk.Entry(Class_Info_Frame,font=('times new roman',12,"bold"),width=21)
        ...
        Proctor_entry=ttk.Entry(Class_Info_Frame,font=('times new roman',12,"bold"),width=20)
        Proctor_entry.grid(row=4,column=3,padx=10,pady=5,sticky=W)

        #Radio Button
        Radiobtn1=ttk.Radiobutton(Class_Info_Frame,text="Take Photo Sample",value="Yes")
        Radiobtn1.grid(row=5,column=0,padx=10,pady=5,sticky=W)
        
        #Radio Button
        Radiobtn2=ttk.Radiobutton(Class_Info_Frame,text="No Photo Sample",value="No")
